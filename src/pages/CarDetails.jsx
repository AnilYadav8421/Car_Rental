...
const CarDetails = () => {
  ...
  return car ? (
    <div className='px-8 sm:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg:col-span-2'>
          ...
          <div className='space-y-6'>
            ...
            <hr className='border-borderColor py-6' />
        ...
        <form className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <button onClick={()=> handleSubmit()} className='w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium text-white rounded-xl cursor-pointer'>Book Now</button>

          <p className='text-sm text-center'>No credit card is need to reserve</p>
        </form>
      </div>
    </div>
  ) : <Loader />
